  ...
  <div>
    <el-card>
      ...
      <el-table :data="fissionList" border stripe>
        ...
        <el-table-column prop="user.phone" label="用户手机号" width="300">
        </el-table-column>
        <el-table-column
          prop="money"
          label="金额"
...
<script>
import { packetList, packetSearch } from "@/api/financial";
...
export default {
  ...
  methods: {
    ...
    getFission() {
      ...
      packetList(pageSize, pageIndex).then((res) => {
        if (res.code === 200) {
          this.fissionList = res.data.list;
