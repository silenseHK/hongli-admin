  ...
  <div>
    <el-card>
      <div slot="header">
        <el-row :gutter="24">
          <el-form :model="orderData" ref="stroleRef">
            ...
            <el-col :span="3" :xl="3" :lg="6" :md="24" :sm="24" :xs="24">
              <el-form-item prop="selectionType">
                <el-select
        ...
        <transition name="el-zoom-in-top">
          <ul class="alert-info" v-if="isStatic">
            ...
            <li>
              <h1>下单金额:</h1>
              <span>{{ staticData.betting_money }}</span>
            </li>
            <li>
              <h1>服务费:</h1>
              <span>{{ staticData.service_charge }}</span>
            </li>
            <li>
              <h1>中奖金额:</h1>
              <span>{{ staticData.win_money }}</span>
            </li>
          </ul>
        </transition>
      </div>
      ...
      <el-table :data="orderLists" border stripe>
        ...
        <el-table-column prop="type" label="订单状态" width="110">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getCharge() {
      ...
      getBetting(pageSize, pageIndex).then((res) => {
        if (res.code === 200) {
    ...
    getSearshs() {
      ...
      const paramData = objDele(searchData);
      const params = {
        conditions: paramData,
        ops: {
          selection: "=",
          betting_num: "=",
          phone: "=",
